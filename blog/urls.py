...
urlpatterns = [
    ...
    path('post/<int:pk>/delete/', PostDeleteConfirm.as_view(),
         name='post_delete_confirm'),
    path('post/<int:pk>/delete/confirm', PostDelete.as_view(),
         name='post_delete'),
    path('post/delete/success', PostDeleteSuccess.as_view(),
    ...
    path('<slug:slug>/approve_comment/<int:comment_id>/',
